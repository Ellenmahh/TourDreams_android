...
public class MelhoresDestinosAdapter extends ArrayAdapter<MelhoresDestinos> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MelhoresDestinos item = getItem(position);// pegar o item que esta sendo carregado
        ...
        if (item != null) {
            ...
            txt_preco_hotel.setText(item.getPreco_quarto());

           Picasso.with(getContext())
                    .load(item.getImagem_hotel_1()) // pega a imagem e carrega ela na image view
